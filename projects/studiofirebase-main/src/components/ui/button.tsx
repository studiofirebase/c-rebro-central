...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-silver text-primary-foreground font-medium hover:brightness-110 transition-all shadow-silver-glow active:scale-98",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 active:scale-98",
        outline:
          "border border-border/50 bg-transparent hover:bg-accent/10 hover:text-accent hover:border-primary/50 active:scale-98",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 active:scale-98",
        ghost: "hover:bg-accent/5 hover:text-accent-foreground active:scale-98",
