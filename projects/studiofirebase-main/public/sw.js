...
const CACHE_NAME = 'italosantos-cache-v4';
const PRECACHE_URLS = [
    '/',
    '/offline.html',
    '/logo.png',
...
const NEXT_ASSET_REGEX = /\/_next\/static\//;
...
self.addEventListener('fetch', (event) => {
    ...
    // Assets do Next.js: network-first para evitar chunks antigos quebrando navegação em mobile.
    if (NEXT_ASSET_REGEX.test(url.pathname)) {
        event.respondWith(
            fetch(req)
                .then((res) => {
